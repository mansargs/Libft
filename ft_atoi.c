...
/*   Updated: 2025/01/13 17:49:42 by mansargs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    test_atoi("abc42");            // Characters followed by numbers (should return 0)
    test_atoi("+987");             // Positive sign
    test_atoi("   -123abc");       // Mixed: whitespace, sign, number, characters
