...
void compare_results(char *your_result, char *expected_result, const char *test_case) {
...
void test_strrchr() {
    ...
    compare_results(ft_strrchr("", 'a'), strrchr("", 'a'), "Empty string with 'a'");

    // Test 2: Character not found in string
    printf("Test 2: Character not found in string\n");
    compare_results(ft_strrchr("Hello World!", 'z'), strrchr("Hello World!", 'z'), "Character 'z' not found");

    // Test 3: Character found at the end of the string
    printf("Test 3: Character found at the end of the string\n");
    compare_results(ft_strrchr("Hello World!", '!'), strrchr("Hello World!", '!'), "Character '!' at the end");

    // Test 4: Multiple occurrences of the character, check last occurrence
    printf("Test 4: Multiple occurrences of the character, check last occurrence\n");
    compare_results(ft_strrchr("abcdabcd", 'a'), strrchr("abcdabcd", 'a'), "Multiple 'a' occurrences");

    // Test 5: Character found at the beginning of the string
    printf("Test 5: Character found at the beginning of the string\n");
    compare_results(ft_strrchr("abcdef", 'a'), strrchr("abcdef", 'a'), "Character 'a' at the beginning");

    // Test 6: String with special characters
    printf("Test 6: String with special characters\n");
    compare_results(ft_strrchr("!@#$%^&*()_+", '%'), strrchr("!@#$%^&*()_+", '%'), "Special character '%'");

    // Test 7: Character is null terminator
    printf("Test 7: Character is null terminator\n");
    compare_results(ft_strrchr("Hello", '\0'), strrchr("Hello", '\0'), "Null terminator");

    // Test 8: Single character string
    printf("Test 8: Single character string\n");
    compare_results(ft_strrchr("a", 'a'), strrchr("a", 'a'), "Single character string 'a'");
    ...
    compare_results(ft_strrchr("abababab", 'b'), strrchr("abababab", 'b'), "Multiple 'b' occurrences");
    ...
    large_str[999999] = 'b';
    compare_results(ft_strrchr(large_str, 'b'), strrchr(large_str, 'b'), "Large string with 'b' at the end");

    // Test 11: Null string input
    printf("Test 11: Null string input\n");
    compare_results(ft_strrchr(NULL, 'a'), strrchr("", 'a'), "Null string input");

    // Test 12: Null character in middle of the string
    printf("Test 12: Null character in middle of the string\n");
    compare_results(ft_strrchr("Hello\0World", '\0'), strrchr("Hello\0World", '\0'), "Null character in middle");

    // Test 13: Search beyond string length
    printf("Test 13: Search beyond string length\n");
    compare_results(ft_strrchr("abcdef", 'g'), strrchr("abcdef", 'g'), "Character 'g' beyond string length");
    ...
    compare_results(ft_strrchr(embedded_null_str, '\0'), strrchr(embedded_null_str, '\0'), "Embedded null characters");

    // Test 15: Search for the first occurrence in a string
    printf("Test 15: Search for the first occurrence in a string\n");
    compare_results(ft_strrchr("aaa", 'a'), strrchr("aaa", 'a'), "First occurrence of 'a'");
}
