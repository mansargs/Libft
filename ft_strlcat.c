...
{
    size_t i = 0,j = 0, strlen_src,strlen_dst;
...
void test_strlcat_dstsize_smaller_than_dst_length() {
    char dst[10] = "Hello";
    char dst_ft[10] = "Hello";
    char src[] = "world";
...
void test_strlcat_empty_dst_and_src() {
    char dst[1] = "";
    char dst_ft[1] = "";
    char src[] = "";
...
void test_strlcat_src_too_long_for_dst() {
    char dst[15] = "Hello";
...
void test_strlcat_exact_dst_length_plus_one() {
    char dst[10] = "Hello";
    char dst_ft[10] = "Hello";
    char src[] = "world";
